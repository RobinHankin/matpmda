...
about 0.36 units higher than the population mean of zero.  What
happens if we repeat this experiment?  We can try the process again
repeatedly, using a single line of R coding:
...
See how the sample mean varies randomly.
