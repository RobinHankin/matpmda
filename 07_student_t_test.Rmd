...
```{r studenttees, fig.cap="The Gaussian distribution and a Student t-distribution for comparison: the two are very similar", out.width='100%',echo=FALSE,message=FALSE,warning=FALSE}
