...
```{r confidenceconcept,fig.cap="Conceptual diagram of confidence interval", out.width='100%',echo=FALSE}
...
```{r confidencefreq,fig.cap="Repeated confidence intervals with intervals missing the true value shown in red", out.width='100%',echo=FALSE}
set.seed(1)
par(lend=1)
