...
```{r criticalregion,fig.cap="The critical region shown in red", out.width='100%',echo=FALSE,message=FALSE,warning=FALSE}
...
```{r onesidedpvalue,fig.cap="pvalue for a one-sided test", out.width='100%',echo=FALSE,message=FALSE,warning=FALSE}
...
```{r twosidedpvalue,fig.cap="pvalue for a two-sided test", out.width='100%',echo=FALSE,message=FALSE,warning=FALSE}
x <- seq(from=-4,to=4,by=0.001)
