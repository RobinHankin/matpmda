...
* _Step 3_.  Realize that the null hypothesis implies that the number of
  ...
  $p=0.2$.  So the number of students with excellence will be
  $\sim\operatorname{Bin}(150,0.2)$.  The expected number of excellence
  students will be $150\times 0.2=30$.   We can use the results from chapter 4 to say that, if the null is true, the number of excellence students will be Gaussian with mean $np=150\times 0.2=30$ and standard deviation $\sqrt{np(1-p)} = 4.9$.
