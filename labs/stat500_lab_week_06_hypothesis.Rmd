---
title: "stat500 lab, week 6, hypothesis testing"
...
```{asis}
Therefore the critical region is the interval $(-\infty, -1.96) \cup
(1.96, \infty) $ or~$\{z\colon\left|z\right| > 1.96\}$
```
...
```{asis}
Observe that the mean and variance are calculated using the {\em true}
