...
If we have observations from a Gaussian distribution with unknown mean
and standard deviation equal to 3, how many observations do we need to
reduce the standard error to 0.1?
