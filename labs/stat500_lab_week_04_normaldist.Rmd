---
title: "stat500 lab, week 4, normal distribution"
...
* Check your answer using random sampling
...
```{asis}
Observe that the results above differ slightly due to random variability
```
