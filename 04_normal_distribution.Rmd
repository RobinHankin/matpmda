...
```{r annotatednorm1,fig.cap="The normal (Gaussian) distribution showing mean and standard deviation.", out.width='100%',echo=FALSE,message=FALSE,warning=FALSE}
...
```{r manynorm,fig.cap="A selection of normal (Gaussian) distributions with different means and standard deviations.  See how the mean value shifts the distribution to the left or the right, and the standard deviation makes the distribution wider or narrower", out.width='100%',echo=FALSE,message=FALSE,warning=FALSE}
...
```{r annotatednorm2,fig.cap="The normal (Gaussian) distribution showing mean and standard deviation.", out.width='100%',echo=FALSE,message=FALSE,warning=FALSE}
mu  <-  0
sigma <- 1
...
```{r binomialnormalplot,fig.cap="A histogram showing the distribution of the bin(100,0.3)", out.width='100%',echo=TRUE,message=FALSE,warning=FALSE}
