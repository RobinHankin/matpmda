...
```{r binomialplot,fig.cap="Tabulated observations from the binomial distribution", out.width='100%',echo=FALSE,message=FALSE,warning=FALSE}
plot(table(x))
```
...
```{r binplot,fig.cap="The binomial distribution", out.width='100%',echo=FALSE,message=FALSE,warning=FALSE}
